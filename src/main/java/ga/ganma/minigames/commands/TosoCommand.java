...
public class TosoCommand implements CommandExecutor {
	...
	Player pla = null;
	public static Location mission1Loc;
	public static Location mission2Loc;
	public static Location mission3Loc;
	public static Location mission4Loc;
	...
	private void start() {
		if (TosoNow.hunter) {
			if (GameSettingsManager.isAllComplete()) {
				...
				mission1Loc = missionLocs.get(0);
				mission2Loc = missionLocs.get(1);
				mission3Loc = missionLocs.get(2);
				mission4Loc = missionLocs.get(3);
